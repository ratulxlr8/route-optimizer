...
- `app/page.tsx` — the order form + results dashboard, with Single Order / Bulk Upload tabs.
- `components/bulk-upload.tsx` — the bulk upload UI (drag-and-drop, template download, results table, export).
